# 🌳 Rastro — Controle Inteligente de Madeira e DOF
...
|                          | Planilhas | Concorrentes genéricos |  **Rastro**   |
| ------------------------ | :-------: | :--------------------: | :-----------: |
...
> **Rastro** — Conformidade ambiental não precisa ser complicada. 🌳
